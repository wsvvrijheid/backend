  ...
  return {
    ...
    getAccountSettings: async function () {
      try {
        ...
        if (debug)
          console.log('twitter hook - get account settings: ', response)
    ...
    removeProfileBanner: async function () {
      try {
        ...
        if (debug)
          console.log('twitter hook - response profile banner: ', response)
    ...
    updateProfileBanner: async function (banner, options) {
      try {
        ...
        if (debug)
          console.log('twitter hook - update profile banner: ', response)
    ...
    updateProfileImage: async function (image) {
      try {
        ...
        if (debug)
          console.log('twitter hook - update profile image: ', response)
